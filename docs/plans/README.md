...
| `observability-sprint-b.md` | 新增（2026-09-08） → 已落地 | 观测链路 Sprint B 执行源。**16 个 PR-OBS-X + 1 fix = 34 commit 全落地**（2026-09-08），见 [stages/stage-44-observability-sprint-b.md](../stages/stage-44-observability-sprint-b.md)。**PR-OBS-17/18/23/15（2026-09-08）§四 B/C 收口**：Stage 45 接口抽象 + Stage 46 HTTP EntrySpan + Stage 47 logging 接入 + Stage 48 err 透传。剩余未做（gRPC interceptor / 业务 handler tag / sw-oap telemetry / 分支 merge）见 stage-44 §四 |
