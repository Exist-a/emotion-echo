...
| `observability-sprint-b.md` | 新增（2026-09-08） → 已落地 | 观测链路 Sprint B 执行源。**16 个 PR-OBS-X + 1 fix = 34 commit 全落地**（2026-09-08），见 [stages/stage-44-observability-sprint-b.md](../stages/stage-44-observability-sprint-b.md)。**PR-OBS-17（2026-09-08）部分收口 §四 B**，见 [stages/stage-45-observability-sprint-b-regression.md](../stages/stage-45-observability-sprint-b-regression.md)。未做项（分支 merge / 业务 tag 路径 / 6 svc logging 接入 / sw-oap telemetry）见 stage-44 §四 |
